...
import logo from './brain-buster-high-resolution-logo-removebg-preview.png';
    ...
    return (
        <>
            <div className={styles.navigationBar}>
                <Link to={'/'}><img className={styles.navLogo} src={logo} alt="Logo" width="200px" /></Link>
                <ul>
                    <Link to={'/aptitude-test'}><li>Aptitude Tests</li></Link>
                    <Link to={'/PrepAccess'}><li>Prep Access</li></Link>
                    <Link to={'/ArticleNews'}><li>Articles & News</li></Link>
