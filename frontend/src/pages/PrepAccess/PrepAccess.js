import styles from './PrepAccess.module.css';
import { Link } from 'react-router-dom';
import questions from '../../assets/images/PrepAccess (1).png';
import details from '../../assets/images/PrepAccess (2).png';
import chart from '../../assets/images/PrepAccess (3).png';
import solution from '../../assets/images/PrepAccess (5).png';
import NavBar from '../../components/NavBar/NavBar';
import Footer from '../../components/Footer/Footer';
import practiceQuestionsIcon from '../../assets/images/stack.jpg';
import detailedSolutionsIcon from '../../assets/images/questionmark.jpg';
import testStatisticsIcon from '../../assets/images/graph.jpg';
import testSimulationsIcon from '../../assets/images/timer.jpg';
import satisfactionGar from '../../assets/images/thumbsup-outline-1.webp';
import questionMark from '../../assets/images/customer-service-line-2.webp';


const features = [
    {
        icon: practiceQuestionsIcon,
        ...
        <div>
            ...
            <div className={styles.pageWrapper}>
                ...
                <div className={styles.prepPlat}>
                    <h2 className={styles.prep}>Test Prep Platform</h2>
                        ...
                        {features.map((feature, index) => (
                            <div key={index} className={styles.featureCard}>
                                <div className={styles.featureIcon}>
                                    <img src={feature.icon} alt={feature.title} className={styles.featureImage} />
                                </div>
                ...
                <h2 className={styles.prep}>About the Platform</h2>
                ...
                <div className={styles.containerPrep}>
                    <div className={styles.card}>
                        <div className={styles.icon}>
                            <img src={satisfactionGar} alt="Satisfaction Guaranteed" />
                        </div>
                    ...
                    <div className={styles.card}>
                        <div className={styles.icon}>
                            <img src={questionMark} alt="Questions" />
                        </div>
